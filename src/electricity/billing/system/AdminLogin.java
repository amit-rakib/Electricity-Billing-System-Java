...
public class AdminLogin extends JFrame implements ActionListener {
    ...
    AdminLogin(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(51, 153, 255), 2), "Admin Login", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(51, 153, 255)));
        ...
        ImageIcon i3 = new ImageIcon(ClassLoader.getSystemResource("icon/cancel2.png"));
        ...
        cancel.setBounds(460, 180, 110, 30);
        cancel.addActionListener(this);
        panel.add(cancel);
        
        ImageIcon i5 = new ImageIcon(ClassLoader.getSystemResource("icon/signup7.png"));
        Image i6 = i5.getImage().getScaledInstance(28, 28, Image.SCALE_DEFAULT);
        signup = new JButton("Customer Login", new ImageIcon(i6));
        signup.setBackground(new Color(0,204,102));
        signup.setForeground(Color.WHITE);
        signup.setFont( new Font("Tahoma", Font.TYPE1_FONT, 14));
        signup.setBounds(360, 240, 180, 30);
        signup.addActionListener(this);
        panel.add(signup);
        
        
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icon/s5.jpg"));
        Image i8 = i7.getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT);
        ImageIcon i9 = new ImageIcon(i8);
        JLabel image = new JLabel(i9);
        image.setBounds(20, 20, 280, 280);
        panel.add(image);
